...
<div class="container my-4 event-calendar">
    ...
    <div class="row font-weight-bold text-center d-none d-md-flex">
        ...
        <div class="col-md-3" style="color: #FCFCFC;">Time</div>
        ...
        <?php foreach ($result as $resultValue): ?>
            <div class="row align-items-start text-center mb-4 text-white">
                ...
                <div class="col-md-3">
                    ...
                    <?php
                    $timeFormatted = date("g:i A", strtotime($resultValue['time']));
                    ?>
                    <p><?= htmlspecialchars($resultValue['slot']) . ' ' . $timeFormatted ?></p>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-1">
                    <a href="login.php" class="btn btn-primary btn-sm px-4 py-1 mt-2" style="font-size: 1rem; line-height: 1;">
                        Join
                    </a>
                </div>
            </div>

...
$getAllUpcomingEvents = $conn->prepare("SELECT * FROM notifications ORDER BY id DESC");
    ...
    <tbody id="table-data">
      <?php foreach ($result as $index => $row): ?>
        <tr>
          ...
          <td>
            <div class="d-flex">
                <a href="add_notification.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-primary " title="Edit">
                <i class="fas fa-edit"></i>
                </a>
                <a href="delete_notification.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger ml-2" title="Delete" onclick="return confirm('Are you sure you want to delete this event?');">
